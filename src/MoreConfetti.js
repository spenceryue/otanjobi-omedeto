...
window.confetti = {};
window.confetti.Context = function(id) {
  var i = 0;
...
export default class MoreConfetti extends React.Component {
  componentDidMount() {
    var confetti = new window.confetti.Context('moreConfetti');
  ...
  render() {
    return (
      <div id='moreConfettiContainer'>
        <canvas id='moreConfetti' />
      </div>
    );
  }
}
